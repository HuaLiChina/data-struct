...
namespace lcmtypes
{
    public sealed class camera_center_line_info_t : LCM.LCM.LCMEncodable
    {
        ...
        public camera_center_line_info_t()
        {
        }
 
        public static readonly ulong LCM_FINGERPRINT;
        public static readonly ulong LCM_FINGERPRINT_BASE = 0xec9103580760cfe8L;
 
        static camera_center_line_info_t()
        {
        ...
        {
            if (classes.Contains("lcmtypes.camera_center_line_info_t"))
                return 0L;
 
            classes.Add("lcmtypes.camera_center_line_info_t");
        ...
        public camera_center_line_info_t(byte[] data) : this(new LCMDataInputStream(data))
        {
        }
 
        public camera_center_line_info_t(LCMDataInputStream ins)
        {
